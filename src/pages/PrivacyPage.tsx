  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      <div className="max-w-2xl mx-auto px-4 py-8">
        ...
        <h1 className="text-xl font-bold text-gray-900 dark:text-gray-100 mt-4 mb-6">プライバシーポリシー</h1>
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6 text-sm text-gray-700 dark:text-gray-300 space-y-4 leading-relaxed">
          <p>本プライバシーポリシーは、Task Manager（以下「本サービス」）における個人情報の取り扱いについて定めます。</p>
          ...
          <p>収集した個人情報を第三者に提供・販売することはありません。ただし、法令に基づく場合を除きます。</p>

          <h2 className="font-semibold text-gray-900 dark:text-gray-100">4. データの保管</h2>
          <p>データはNeon PostgreSQL（クラウドデータベース）に保管されます。パスワードはハッシュ化して保存しており、平文では保存しません。</p>

          <h2 className="font-semibold text-gray-900 dark:text-gray-100">5. データの削除</h2>
          <p>ユーザーはアカウント設定画面からいつでもアカウントを削除できます。アカウント削除時に、ユーザーに紐付くすべてのデータが完全に削除されます。</p>

          <h2 className="font-semibold text-gray-900 dark:text-gray-100">6. Cookie</h2>
          <p>本サービスではCookieは使用しません。認証情報はブラウザのローカルストレージに保存されます。</p>
