...
| `api-body-size-limit`      | `/api/*` (body > 64 KB)                   | —               | 1 block/5min    | edge での大量 body 弾き (多層防御)              |
| `api-global-rate-limit`    | `/api/*` 全体                             | 2000            | 100 blocks/5min | DDoS 緩衝                                       |
...
- アラーム: `task-app-waf-auth-blocks`, `task-app-waf-auth-mutating-blocks`, `task-app-waf-api-global-blocks`, `task-app-waf-api-body-size-blocks`
